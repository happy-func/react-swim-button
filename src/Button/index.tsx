...
export default function ReactSwimButton(props: IProps) {
  ...
  return (
    <div
      className={classNames("swim-button-box", className, {
    ...
    >
      <div
        ref={water}
        className={classNames("swim-button-wave")}
        style={{ left: 0 }}
      />
      <span className={classNames("swim-button")}>
        {icon && !loading && (
          <span className={classNames("swim-button-icon")}>{icon}</span>
        )}
        {loading && (
          <span className={classNames("swim-button-icon")}>
            <Loading />
          </span>
        )}
        {children}
...
function Loading() {
  return (
    <span role="img" className={classNames("swim-button-loading")}>
      <svg
